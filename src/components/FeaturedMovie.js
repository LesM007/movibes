...
const FeaturedMovie = () => {
  ...
  useEffect(() => {
    if (reloadImage) {
      ...
      axios(
        `https://api.themoviedb.org/3/movie/popular?api_key=d27cfb6baa191e1cd0eaa5f32b9e1d80&language=en`
      )
  ...
  useEffect(() => {
    if (feature) {
      axios(
        `https://api.themoviedb.org/3/movie/${feature.id}/images?api_key=d27cfb6baa191e1cd0eaa5f32b9e1d80&language=en`
      )
        .then((response) => {
